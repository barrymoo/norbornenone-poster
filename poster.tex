...
\renewcommand{\Im}{\operatorname{Im}} %% Re and Im as it is the default
...
\pbox{0.98\textwidth}{}{linewidth=2mm,framearc=0.3,linecolor=ubblue,fillstyle=gradient,gradangle=0,gradbegin=ubgray,gradend=white,gradmidpoint=1.0,framesep=1em}{
    ...
    \begin{center}
        ...
        \hspace{5cm}
        {\sc \huge The Exceptionally Large Optical Rotation of Norbornenone\cite{Autschbach:2012k}}\\[5mm]
        \hspace{5cm}
...
\vspace{0.25cm}
    ...
    from a direct calculation of the OR.}
    \end{center}
...
\vspace{1.00cm} %Increased spacer size normally 0.25cm
    ...
    \beta(\omega) = - \frac{2}{3} \Im \sum_{u = x,y,z} \sum_i
    \Braket{\frac{\D \varphi_i}{\D E_u(+\omega)} + \frac{\D \varphi_i}{\D
    E_u(-\omega)}|\frac{\D \varphi_i}{\D B_u (0)}} 
    := \frac{1}{3} \sum_{u = x,y,z} \sum_i \int \feb{u} dV
    \end{equation}
